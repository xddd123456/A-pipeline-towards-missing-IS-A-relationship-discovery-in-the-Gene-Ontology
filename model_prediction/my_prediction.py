...
x1_train, x2_train, y_train = data['X1'].values, data['X2'].values, data['Label'].values
...
print(embedding_matrix_name.shape)
...
save_dir = "model_results/go_2022"
...
torch.save(model.state_dict(), os.path.join(save_dir, "prediction_model_weight_train_1_change"
                                                      ".pth"))
