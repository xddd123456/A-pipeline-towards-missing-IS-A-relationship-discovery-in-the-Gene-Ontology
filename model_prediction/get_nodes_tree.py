...
# 读取数据
df = pd.read_csv('../data/go_2023/is_a_relations_indexed.csv', usecols=[0, 1], sep='\t', header=None)
...
siblings_df.to_csv('prediction_data/go_2023/siblings.csv', index=False, sep='\t')
print()
# 打印前几个兄弟节点对作为示例
